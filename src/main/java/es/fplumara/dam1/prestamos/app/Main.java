...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // MaterialService materialService = new MaterialRepositoryImpl(materialRepository);
        ...
        List<RegistroMaterialCsv> registroMaterialCsvsList = csvMaterialImporter.leer("C:/PoolIllahuamanCostillo/workspaces-programacion/prestamos/data/materiales.csv");
